    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['UNLEASH', 'YOUR POWER', 'AT GYMNATION.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                ...
                style={{
                  ...
                  fontWeight: line === 'YOUR POWER' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            1500+ Members &middot; CBD Location &middot; 6AM-9PM
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          GYMNATION FITNESS &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['STRENGTH', 'CARDIO', 'GROUP FITNESS', 'PERSONAL TRAINING', 'BOXING', 'RECOVERY'];
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Premium Equipment', desc: 'Top-brand machines and free weights, regularly maintained and replaced.' },
    { title: 'Expert Trainers', desc: 'Certified personal trainers who genuinely care about your progress.' },
    { title: 'Inclusive Atmosphere', desc: 'Every fitness level welcome. No intimidation, no judgment, just results.' },
    { title: 'Flexible Membership', desc: 'Monthly, quarterly, and annual options. No long-term lock-in contracts.' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-red-600">GYMNATION</span>
            </h2>
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={homeCta.backgroundImage} alt="GYMNATION FITNESS" className="w-full h-[130%] object-cover object-center" loading="lazy" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 1 }}>
          ...
          <h2 className="font-heading text-white leading-[0.92] italic mb-8" style={{ fontSize: 'clamp(2.5rem, 8vw, 6rem)' }}>
            YOUR FITNESS<br />
            <span className="text-red-600">STARTS NOW</span>
          </h2>
