      ...
      <div className="relative z-20 grid lg:grid-cols-2 min-h-screen">
        <motion.div className="flex flex-col justify-center px-6 sm:px-10 lg:px-16 py-32 lg:py-20" style={{ y: textY, opacity }}>
          ...
          <div className="overflow-hidden">
            {(hero.titleLines || ['ELEVATE','DAILY.']).map((line, i) => (
        ...
        <div className="relative hidden lg:block">
          <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=1200&q=80" alt="GYMNATION FITNESS" className="absolute inset-0 w-full h-full object-cover object-center" loading="eager" />
...
function StatsStrip() {
  ...
  const ds = stats?.length ? stats : [{ number: '4', label: 'Reviews' }, { number: '4.8', label: 'Stars' }, { number: '300', label: 'Members' }, { number: '20', label: 'Classes' }];
  return (
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src="https://images.unsplash.com/photo-1540497077202-7c8a3999166f?w=1200&q=80" alt="GYMNATION FITNESS" className="w-full h-[130%] object-cover object-center" loading="eager" />
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href={`https://wa.me/${business.whatsappNumber || '263781292959'}`} target="_blank" rel="noopener noreferrer"
